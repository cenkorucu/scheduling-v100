...
const App = () => {
  ...
  const initialRotationSets = {
    'PGY-1': [
      ...
      { name: 'Elective', included: true, mandatory: false, requiredPerBlock: '', type: 'exact', min: '', max: '', exact: 3 },
    ],
    'PGY-2': [
      { name: 'ICU Night', included: true, mandatory: true, requiredPerBlock: 1, type: 'minMax', min: 1, max: 2, exact: '' },
      { name: 'NF', included: true, mandatory: true, requiredPerBlock: 2, type: 'minMax', min: 2, max: 3, exact: '' },
      { name: 'IMP', included: true, mandatory: true, requiredPerBlock: 1, type: 'minMax', min: 1, max: 2, exact: '' },
      { name: 'ICU Day', included: true, mandatory: true, requiredPerBlock: 1, type: 'minMax', min: 1, max: 2, exact: '' },
      { name: 'MAR', included: true, mandatory: true, requiredPerBlock: 1, type: 'minMax', min: 1, max: 2, exact: '' },
      { name: 'CCU Night', included: true, mandatory: true, requiredPerBlock: 1, type: 'minMax', min: 1, max: 2, exact: '' },
      { name: 'Team A', included: true, mandatory: true, requiredPerBlock: 1, type: 'minMax', min: 1, max: 2, exact: '' },
      { name: 'CCU Day', included: true, mandatory: true, requiredPerBlock: 1, type: 'minMax', min: 1, max: 2, exact: '' },
      { name: 'Team B', included: true, mandatory: true, requiredPerBlock: 1, type: 'minMax', min: 1, max: 2, exact: '' },
      { name: 'Elective', included: true, mandatory: false, requiredPerBlock: '', type: 'exact', min: '', max: '', exact: '4' },
    ],
    'PGY-3': [
      { name: 'MON', included: true, mandatory: true, requiredPerBlock: 1, type: 'minMax', min: 1, max: 2, exact: '' },
      { name: 'ICU Night', included: true, mandatory: true, requiredPerBlock: 1, type: 'minMax', min: 1, max: 2, exact: '' },
      { name: 'ICU Day', included: true, mandatory: true, requiredPerBlock: 1, type: 'minMax', min: 1, max: 2, exact: '' },
      { name: 'MOD', included: true, mandatory: true, requiredPerBlock: 1, type: 'minMax', min: 1, max: 2, exact: '' },
      { name: 'Elective', included: true, mandatory: true, requiredPerBlock: 1, type: 'minMax', min: 1, max: 2, exact: '' },
      { name: 'Team A', included: true, mandatory: true, requiredPerBlock: '', type: 'exact', min: 1, max: 2, exact: '1' },
      { name: 'Team B', included: false, mandatory: false, requiredPerBlock: '', type: 'minMax', min: '', max: '', exact: '' },
      { name: 'Palliative', included: true, mandatory: false, requiredPerBlock: '', type: 'exact', min: '', max: '', exact: '1' },
    ],
    'Custom': [],
  };
